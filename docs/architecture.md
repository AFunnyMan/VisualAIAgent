...
2026-09-21 界面改版采用工作台、记忆、提醒、行为统计、设置五个入口；工作台预览/对话双栏，隐藏页面按需执行。设备选择保存在独立会话偏好中，仅点击开始后应用；实际加载身份不随下拉选择改变。界面结构、刷新与回退边界见 [工作台说明](ui-workbench-20260921.md)。未改变业务 API、数据库模式或七工具契约。
